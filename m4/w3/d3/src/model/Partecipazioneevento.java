...
/**
 * The persistent class for the partecipazioneevento database table.
 * 
 */
@Entity
@NamedQuery(name="Partecipazioneevento.findAll", query="SELECT p FROM Partecipazioneevento p")
public class Partecipazioneevento implements Serializable {
